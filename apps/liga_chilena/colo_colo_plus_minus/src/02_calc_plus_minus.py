...
Uso:
    venv312/Scripts/python.exe apps\\liga_chilena\\colo_colo_plus_minus\\src\02_calc_plus_minus.py
"""
...
PROCESSED_DIR = BASE_DIR / "apps" / "liga_chilena" / "colo_colo_plus_minus" / "data" / "processed"
